...
public class SystemInfo {
  ...
  public static String getFriendlyByteSize(long size) {
    if (size > 1024) {
      ...
      return Amethy.COLOR + size + "&rB";
    }
    if (size > 1024) {
      size = size / 1024;
    } else {
      return Amethy.COLOR + size + "&rK";
    }
    if (size > 1024) {
      size = size / 1024;
    } else {
      return Amethy.COLOR + size + "&rM";
    }
    if (size > 1024) {
      size = size / 1024;
    } else {
      return Amethy.COLOR + size + "&rG";
    }
    if (size > 1024) {
      size = size / 1024;
    } else {
      return Amethy.COLOR + size + "&rT";
    }
    return Amethy.COLOR + size + "&rP";
  }
