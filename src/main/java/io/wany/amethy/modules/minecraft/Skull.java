package io.wany.amethy.modules.minecraft;
...
public class Skull {
  ...
  public PlayerProfile toPlayerProfile() {
    ...
    if (this.playerProfile == null) {
      ...
      this.playerProfile.setName(null);
      this.playerProfile.setId(null);
      this.playerProfile.setProperty(new ProfileProperty("textures", this.texture));
    }
    return this.playerProfile;
  }

  public static Skull PREV = new Skull(
  ...
  public static Skull NEXT = new Skull(
  ...
  public static Skull SETTINGS = new Skull(
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTk0OWExOGNiNTJjMjkzZmU3ZGU3YmExMDE0NjcxMzQwZWQ3ZmY4ZTVkNzA1YjJkNjBiZjg0ZDUzMTQ4ZTA0In19fQ==");
  public static Skull SPEECH_BUBBLE = new Skull(
  ...
  public static Skull MESSAGE = new Skull(
  ...
  public static Skull GOD = new Skull(
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjZkNDI3YTg5YzRjYmZkOTk4ODI2YzY0MjViNjNiZmM3ZmJkMmVkZjgxZWI3ZjUyODE4NmJlNjZjNTQ1ZTc5In19fQ==");
  public static Skull RADIO = new Skull(
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTQ4YThjNTU4OTFkZWM3Njc2NDQ0OWY1N2JhNjc3YmUzZWU4OGEwNjkyMWNhOTNiNmNjN2M5NjExYTdhZiJ9fX0=");
  public static Skull APPLE = new Skull(
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGNhZmVmMjhjNzQ1NjIzMGU2ZDI2MTgwMmJjNjI2ZTBkOTRhNjU5YmIyYmJmNTljMjdmZjZhNTU0ZWIxOWQ4NSJ9fX0=");

  public static Skull NOTE_BLOCK = new Skull(
  ...
  public static Skull GRASS_BLOCK = new Skull(
  ...
  public static Skull COMMAND_BLOCK = new Skull(
  ...
  public static Skull CHARACTER_A_WHITE = new Skull(
  ...
  public static Skull CHARACTER_B_WHITE = new Skull(
  ...
  public static Skull CHARACTER_C_WHITE = new Skull(
  ...
  public static Skull CHARACTER_D_WHITE = new Skull(
  ...
  public static Skull CHARACTER_E_WHITE = new Skull(
  ...
  public static Skull CHARACTER_I_WHITE = new Skull(
  ...
  public static Skull CHARACTER_J_WHITE = new Skull(
  ...
  public static Skull CHARACTER_P_WHITE = new Skull(
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWY0YzIxZDE3YWQ2MzYzODdlYTNjNzM2YmZmNmFkZTg5NzMxN2UxMzc0Y2Q1ZDliMWMxNWU2ZTg5NTM0MzIifX19");
  public static Skull CHARACTER_Q_WHITE = new Skull(
  ...
  public static Skull CHARACTER_S_WHITE = new Skull(
  ...
  public static Skull CHARACTER_T_WHITE = new Skull(
  ...
  public static Skull CHARACTER_C_LIME = new Skull(
  ...
  public static Skull CHARACTER_P_PURPLE = new Skull(
      "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmYzYzRiZDZmZDRlMTVkZmZhYzM0NjgwYTc2NmI4YTJiNWQ1MjM0NTFjYmQzZjk4MzQyOTRjYzhmMmM5MmJmIn19fQ==");
