package io.wany.amethy.modules.wand;
...
import io.wany.amethy.modules.wand.command.WandBrushCommand;
...
public class Wand {
  ...
  public static void load() {
    ...
    Material material;
    Material mat = Material.getMaterial(Amethy.YAMLCONFIG.getString("wand.edit.normal-item"));
    if (mat != null) {
      material = mat;
    } else {
    ...
    if (Amethy.YAMLCONFIG.isInt("wand.undo-limit")) {
      undoLimit = Amethy.YAMLCONFIG.getInt("wand.undo-limit");
  ...
  public static void onEnable() {
    ...
    if (!Amethy.YAMLCONFIG.getBoolean("wand.enable")) {
