...
public class console {
  ...
  private static String process(String message) {
    if (message.startsWith(Amethy.PREFIX)) {
      message = message.substring(Amethy.PREFIX.length());
    }
  ...
  public static void info(String message) {
    log(Level.INFO, Amethy.PREFIX_CONSOLE + process(message) + "\u001b[0m");
  }

  public static void warn(String message) {
    log(Level.WARN, Amethy.PREFIX_CONSOLE + "\u001b[93m" + process(message) + "\u001b[0m");
  }

  public static void error(String message) {
    log(Level.ERROR, Amethy.PREFIX_CONSOLE + "\u001b[91m" + process(message) + "\u001b[0m");
  }

  public static void fatal(String message) {
    log(Level.FATAL, Amethy.PREFIX_CONSOLE + "\u001b[97;41m" + process(message) + "\u001b[0m");
  }

  public static void debug(String message) {
    if (Amethy.DEBUG) {
      log(Level.INFO, Amethy.PREFIX_CONSOLE + "[DEBUG] " + process(message) + "\u001b[0m");
    }
  }
